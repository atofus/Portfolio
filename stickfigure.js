class Figure {
    constructor(game, x, y) {
        ...
        this.state = 3; //0 = running, 1 = jumping, 2 = falling, 3 = sliding
    ...
    loadAnimations () {
        ...
        this.animations[1][1][0] = new Animator(ASSET_MANAGER.getAsset("./images/jump-white-flipped.png"), 180, 30, 188, 208, 1, 1, true, true); //work on left features
        this.animations[1][2][0] = new Animator(ASSET_MANAGER.getAsset("./images/fall-white-flipped.png"),-25, 20, 170, 175, 3, 0.3, true, true);
        this.animations[1][3][0] = new Animator(ASSET_MANAGER.getAsset("./images/slide-white-flipped.png"), -7, 27, 201, 208, 5, 0.08, true, true);
